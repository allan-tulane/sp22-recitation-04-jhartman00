...
if __name__ == "__main__":
    print("Testing work count map")
    test_word_count_map()
    print("Word count map passed")
    print("Testing word count reduce")
    test_word_count_reduce()
    print("Word count reduce passed")
    print("Testing word count")
    test_word_count()
    print("Word count passed")
    print("Testing sentiment map")
    test_sentiment_map()
    print("Sentiment map passed")
    print("Testing test sentiment")
    test_sentiment()
    print("Test sentiment passed")
